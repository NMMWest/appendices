 class Population {
  ...
  generate() {
    ...
    for (let i = 0; i < this.population.length; i++) {
      ...
      //for now, just giving it another shot, to reduce the number of single lines
      ...
      // let copyA = JSON.parse(JSON.stringify(partnerA));
      // let copyB = JSON.parse(JSON.stringify(partnerB));

      //pairings.push([copyA,copyB]);
      //pairings.push([partnerA.uID,partnerB.uID]);
